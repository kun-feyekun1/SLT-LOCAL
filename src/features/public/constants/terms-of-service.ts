...
import type { LegalSectionData } from '../components/LegalSection';
    ...
    paragraphs: [
      {
        id: 'acceptable-use-1',
        text:
          'You must use Smart Link Transit lawfully, safely, and respectfully.',
      },
    ],
    bullets: [
...

  {
    ...
    paragraphs: [
      ...
      },
      {
        id: 'disclaimers-2',
        text:
          'Nothing in these terms excludes warranties or responsibilities that cannot legally be excluded.',
      },
    ],
  },
    ...
    paragraphs: [
      {
        id: 'contact-1',
        text:
          `Questions about these terms may be sent to ${PUBLIC_CONFIG.legalEmail}.`,
      },
    ],
  },
];